...
public class TutorialScene {
    public interface TutorialListener {
        /** Triggered after the glitch + 2x blink so the character spawns in the maze. */
        void onSpawnIntoMaze();

        /** Triggered after all post-spawn tutorial dialogue is done. */
    ...
    // SFX: play a looping "type" sound while any typewriter is animating.
    ...
    public TutorialScene(SpriteBatch batch, TutorialListener listener) {
        ...
        // Optional typing SFX (loops while typewriter is active).
        ...
        // Complaint panel at the bottom (SubmenuPanel dialogue visible).
